...
from routers import settings_router, simulation_router, device_simulation_router, publisher_router, algorithms_router, simulation_data_router, ocr_router
...
app.include_router(simulation_data_router.router)
